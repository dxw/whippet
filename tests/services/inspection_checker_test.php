...
EOT;
	...
	{
		$inspection_ok = $this->fakeInspection(date_create('2015-05-01'), '2.3.4', 'No issues found', 'https://advisories.dxw.com/plugins/another_plugin/');
		$inspection_caution = $this->fakeInspection(date_create('2016-01-23'), '3.0.0', 'Use with caution', 'https://advisories.dxw.com/plugins/another_plugin2/');
