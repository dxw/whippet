...
class Json_Api_Test extends PHPUnit_Framework_TestCase
{
    ...
    {
        $base_api = $this->fakeBaseApi();
        $base_api->method('get')->willReturn(\Result\Result::ok('[]'));
    ...
    public function testWithInspections()
    {
        ...
        $base_api = $this->fakeBaseApi();
        $base_api->method('get')->willReturn(\Result\Result::ok($response_body));
    ...
    {
        $stub = $this->createMock('\\Dxw\\Whippet\\Services\\BaseApi');
        return $stub;
    }
}
