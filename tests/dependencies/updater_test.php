...
class Dependencies_Updater_Test extends \PHPUnit\Framework\TestCase
{
	...
	public function testUpdateAll()
	{
		...
		$whippetLock = $this->getWhippetLockWritable([
			['themes', 'my-theme', 'git@github.com:dxw-wordpress-themes/my-theme', '27ba906'],
		...
		$this->addFactoryCallStatic('\\Dxw\\Whippet\\Git\\Git', 'ls_remote', 'git@github.com:dxw-wordpress-themes/my-theme', 'v1.4', \Result\Result::ok('27ba906'));
	...
	public function testUpdateAllFailedGitCommand()
	{
		...
		$this->addFactoryCallStatic('\\Dxw\\Whippet\\Git\\Git', 'ls_remote', 'git@github.com:dxw-wordpress-themes/my-theme', 'v1.4', \Result\Result::err('oh no'));
	...
	public function testUpdateAllWithoutRef()
	{
		...
		$this->addFactoryCallStatic('\\Dxw\\Whippet\\Git\\Git', 'ls_remote', 'git@github.com:dxw-wordpress-themes/my-theme', 'main', \Result\Result::ok('27ba906'));
	...
	public function testUpdateAllWithoutRefUsingMaster()
	{
		...
		$this->addFactoryCallStatic('\\Dxw\\Whippet\\Git\\Git', 'ls_remote', 'git@github.com:dxw-wordpress-themes/my-theme', 'main', \Result\Result::err('no such branch'));
		$this->addFactoryCallStatic('\\Dxw\\Whippet\\Git\\Git', 'ls_remote', 'git@github.com:dxw-wordpress-themes/my-theme', 'master', \Result\Result::ok('27ba906'));
